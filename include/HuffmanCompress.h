...
#ifndef INCLUDE_HUFFMANCOMPRESS_H_
#define INCLUDE_HUFFMANCOMPRESS_H_
...
class HuffmanCompress : public ICompress {
 ...
 private:
    //  统计字节形成的字符串词频（固定256个）
    static bool readFreqTable(const std::string& sourcePath, std::array<uint64_t, 256>& freqTable,
